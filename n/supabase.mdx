...
sidebarTitle: "How Supabase launches"
...
<Info>
  Originally published by [Ant Wilson](https://x.com/antwilson) on [supabase.com](https://supabase.com/blog/supabase-how-we-launch).
</Info>
...
During the last week of March 2021, we went on to ship 7 major features. We once again saw an immediate uptick in growth rate which helped solidify our strategy.
...
<Card title="supabase-community on GitHub" href="https://github.com/supabase-community">
  Client libraries and more maintained and supported by the Supabase Community
</Card>
...
<Card title="/launch-week" href="https://supabase.com/launch-week">
...
<Card title="/careers" href="https://supabase.com/careers">
  Explore remote opportunities and join Supabase to help build the best developer platform
</Card>
